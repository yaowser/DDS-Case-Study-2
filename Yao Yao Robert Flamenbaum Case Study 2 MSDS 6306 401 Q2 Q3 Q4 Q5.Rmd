...
par(new=TRUE)
plot(stockAGIO$LogReturns$vol30,type="l",xlab="Year",ylab="Volatility", ylim = c(0,0.12), 
     col="red")
par(new=TRUE)
plot(stockAGIO$LogReturns$vol100,type="l",xlab="Year",ylab="Volatility", ylim = c(0,0.12), 
     col="blue")
